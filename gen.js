...
const data = [
  ...
  },
  {
    ...
    "Grammar Point": "〜ておく",
    "Scenario Context": "在夜班开始前，领班用日语说明对机器 of 检查准备。",
  ...
  },
  {
    ...
    "Learning Content (Japanese)": "冷凍庫 of 温度確認は、退勤する時間【までに】行ってください。",
...
const wscols = [
  {wch: 15}, {wch: 15}, {wch: 8}, {wch: 25}, {wch: 12}, {wch: 18}, {wch: 15},
  {wch: 40}, {wch: 40}, {wch: 50}, {wch: 50}, {wch: 25}, {wch: 45}, {wch: 45}, {wch: 45}
];
ws['!cols'] = wscols;
